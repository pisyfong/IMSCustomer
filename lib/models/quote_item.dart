...
class QuoteItem {
  ...
  // Convert to JSON for logging and server communication
  Map<String, dynamic> toJson() {
    return {
      ...
      'Quote_Quantity_Loose': quoteQuantityLoose,
      'Quote_Foc': quoteFoc,
      'Quote_Foc_Loose': quoteFocLoose,
      'Unit_Price': unitPrice,
      'Unit_Price_Basic': unitPriceBasic,
      'Approval_Unit_Price': approvalUnitPrice,
      ...
      'Plu_No': pluNo,
      'Remark': remark,
      'Instant_Normal_Selling_Price': instantNormalSellingPrice,
      'Average_Cost': averageCost,
      'Standard_Cost': standardCost,
      'Fifo_Cost': fifoCost,
      'Last_Cost': lastCost,
      'Balance_Quantity': balanceQuantity,
      'Balance_Quantity_Loose': balanceQuantityLoose,
      'Balance_Foc': balanceFoc,
      'Balance_Foc_Loose': balanceFocLoose,
      'Cancelled_By': cancelledBy,
      'Cancelled_Date': cancelledDate?.toIso8601String(),
      'Location_Code': locationCode,
      'Added_Date': addedDate?.toIso8601String(),
      'Unit_Discount_Rate2': unitDiscountRate2,
      'Unit_Discount_Amount2': unitDiscountAmount2,
      'Unit_Discount_Rate1': unitDiscountRate1,
      'Unit_Discount_Amount1': unitDiscountAmount1,
      'Project_Code': projectCode,
      'SY_Location_Code': syLocationCode,
      'Misc_Cost': miscCost,
      'Default_Plu': defaultPlu,
      'CTN_Uom': ctnUom,
      'CTN_Unit_Price': ctnUnitPrice,
      'Alternate_Description': alternateDescription,
      'Item_Sequence': itemSequence,
      'GST_Code': gstCode,
      'GST_Price': gstPrice,
      'Change_Price_Remark': changePriceRemark,
      'Quote_Quantity_Ori': quoteQuantityOri,
      'Quote_Quantity_Loose_Ori': quoteQuantityLooseOri,
      'Quote_Foc_Ori': quoteFocOri,
      'Quote_Foc_Loose_Ori': quoteFocLooseOri,
      'Unit_Price_Ori': unitPriceOri,
      'Unit_Discount_Rate_Ori': unitDiscountRateOri,
      'Unit_Discount_Amount_Ori': unitDiscountAmountOri,
      'Quantity_Loss': quantityLoss,
